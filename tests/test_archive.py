...
class ArchiveTestCase(unittest.TestCase):
    ...
    def test_archive_trivial(self):
        assert self.arc.setOwnership('1.1.1.1', 'hello.txt', True) == True

    def test_archive_2Files1IP(self):
        assert self.arc.setOwnership('1.1.1.1', 'hello.txt', True) == True
        assert self.arc.setOwnership('1.1.1.1', 'hello2.txt', True) == True

    def test_archive_2Files2IPs(self):
        assert self.arc.setOwnership('1.1.1.1', 'hello.txt', True) == True
        assert self.arc.setOwnership('1.1.1.2', 'hello2.txt', True) == True

    def test_archive_1File2IPsR(self):
        assert self.arc.setOwnership('1.1.1.1', 'hello.txt', False) == True
        assert self.arc.setOwnership('1.1.1.2', 'hello.txt', False) == True

    def test_archive_1File2IPsW(self):
        assert self.arc.setOwnership('1.1.1.1', 'hello.txt', True) == True
        assert self.arc.setOwnership('1.1.1.2', 'hello.txt', True) == False
    ...
    def test_archive_1File2IPsRW2(self):
        assert self.arc.setOwnership('1.1.1.1', 'hello.txt', True) == True
        assert self.arc.setOwnership('1.1.1.2', 'hello.txt', False) == False

    def test_archive_releaseW(self):
        assert self.arc.setOwnership('1.1.1.1', 'hello.txt', True) == True
        assert self.arc.setOwnership('1.1.1.2', 'hello.txt', True) == False
        self.arc.releaseOwnership('1.1.1.1', 'hello.txt')
        assert self.arc.setOwnership('1.1.1.2', 'hello.txt', True) == True

    def test_archive_releaseR(self):
        assert self.arc.setOwnership('1.1.1.1', 'hello.txt', False) == True
        assert self.arc.setOwnership('1.1.1.2', 'hello.txt', False) == True
        self.arc.releaseOwnership('1.1.1.1', 'hello.txt')
        assert self.arc.setOwnership('1.1.1.3', 'hello.txt', False) == True
    ...
    def test_archive_releaseRW3(self):
        ...
        assert self.arc.setOwnership('1.1.1.2', 'hello.txt', False) == True
        assert self.arc.setOwnership('1.1.1.3', 'hello.txt', False) == True
        assert self.arc.setOwnership('1.1.1.4', 'hello.txt', True) == False
        self.arc.releaseOwnership('1.1.1.1', 'hello.txt')
        assert self.arc.setOwnership('1.1.1.4', 'hello.txt', True) == False
        self.arc.releaseOwnership('1.1.1.2', 'hello.txt')
        assert self.arc.setOwnership('1.1.1.4', 'hello.txt', True) == False
        self.arc.releaseOwnership('1.1.1.3', 'hello.txt')
        assert self.arc.setOwnership('1.1.1.4', 'hello.txt', True) == True
